...
\end{lema}
\begin{pf}
The graph $F_6$ (see Figure~\ref{fig:16proibidos}(f)) is a graph that can be obtained by construction of the Lemma~\ref{lem:obstrucaoGeneralizada}. Thus, $F_6$ also is not a $B_1$-EPG graph.
 $\square$\end{pf}} 
...
\end{lema}
\begin{pf}
The graph $F_7$ (see Figure~\ref{fig:16proibidos}(g)) is a graph that can be obtained by construction of the Lemma~\ref{lem:obstrucaoGeneralizada}. Thus, $F_7$ also is not a $B_1$-EPG graph.
 $\square$\end{pf} }
